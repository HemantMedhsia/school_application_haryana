  ...
  return (
    <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
      ...
      <div className="block w-full overflow-x-auto">
        <table className="items-center w-full border-collapse text-black">
          <thead>
            <tr>
              <th className="px-6 bg-gray-200 text-gray-800 align-middle border-b border-gray-200 py-3 text-xs uppercase font-semibold text-left">Name</th>
              <th className="px-6 bg-gray-200 text-gray-800 align-middle border-b border-gray-200 py-3 text-xs uppercase font-semibold text-left">Roll No</th>
              <th className="px-6 bg-gray-200 text-gray-800 align-middle border-b border-gray-200 py-3 text-xs uppercase font-semibold text-left">Exam Type</th>
              <th className="px-6 bg-gray-200 text-gray-800 align-middle border-b border-gray-200 py-3 text-xs uppercase font-semibold text-left">Percentage</th>
              <th className="px-6 bg-gray-200 text-gray-800 align-middle border-b border-gray-200 py-3 text-xs uppercase font-semibold text-left">Actions</th>
              <th className="px-6 bg-gray-200 text-gray-800 align-middle border-b border-gray-200 py-3 text-xs uppercase font-semibold text-left">View All</th>
            </tr>
          </thead>
          <tbody>
              ...
              <tr key={rowIndex} className="hover:bg-gray-100">
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4 text-left">
                  {item.examTypes.map((examType, examIndex) => (
                    <div key={examIndex} className="flex items-center mb-2">
                      <span>{examType}</span>
                    </div>
                  ))}
                </td>
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4 text-left">
                  {item.examTypes.map((examType, examIndex) => (
                    <div key={examIndex} className="mb-2">
                      <button
