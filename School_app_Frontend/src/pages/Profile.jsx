  ...
  const renderCard = (title, details) => (
    <div className="bg-gray-900 shadow overflow-hidden sm:rounded-lg mb-6 w-full">
      <div className="px-4 py-5 sm:px-6">
        <h3 className="text-xl font-semibold leading-6 text-[#7367F0]">{title}</h3>
  ...
  return (
    <div className="w-full bg-gray-900 text-white rounded-lg overflow-hidden">
      ...
      <div className="flex flex-wrap gap-6 my-6">
        <section ref={personalInfoRef} className="flex-1 min-w-[48%] text-[#7367F0]">
          ...
          {renderCard("Academic Details", [
            {
              ...
              value: new Date(studentData.admissionDate).toLocaleDateString(),
            },
            ...
            { label: "Weight", value: `${studentData.weight} kg` },
            {
              ...
              value: new Date(studentData.measurementDate).toLocaleDateString(),
            },
